...
# API INITIALIZATION
######################################################################
# Define namespaces for Orders and Items to organize API endpoints
# Namespaces help group related endpoints and improve Swagger documentation
...
# API Models
######################################################################
# These models define the Swagger/OpenAPI data schemas for request/response
# validation and documentation. They ensure API consistency and provide
# automatic documentation generation.
######################################################################


# Full Item model with all fields including auto-generated id
...
# Item creation model (without id, as id is auto-generated by the database)
...
# Full Order model with all fields including auto-generated id and nested items
# Used for GET responses to return complete order information
...
# Order creation model (id and total_price are optional/auto-calculated)
# Used for POST/PUT requests to create or update orders
...
# Define request parsers for query parameter validation
# These parsers automatically validate and parse query parameters from GET requests
...
# Item list request parser for filtering items by various criteria
...
# Register item resources in a separate namespace
# Route for item collection endpoints
